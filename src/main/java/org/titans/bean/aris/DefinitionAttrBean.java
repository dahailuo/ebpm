 ...
 */
@Entity
@Table(name = "aris_definition_attr")
public class DefinitionAttrBean {
     ...
     * @return 对应字段
     */
    @Column(name = "attr_type_num", insertable=false,updatable=false)
     ...
     * @return 对应字段
     */
    @Column(name = "type_guid", length = 36,insertable=false,updatable=false)
