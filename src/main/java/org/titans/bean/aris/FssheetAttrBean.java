 ...
 */
@Entity
@Table(name = "aris_fssheet_attr")
public class FssheetAttrBean {
     ...
     * 内容.
     */
    private Clob plaintnfclob;
    /**
     * 内容.
     */
    private Clob styledtextclob;
    /**
     * 下拉key值.
     */
     ...
     */
    public void setPlaintextclob(Clob plaintextclob) {
     ...
     */
    public void setPlaintnfclob(Clob plaintnfclob) {
     ...
     */
    public void setStyledtextclob(Clob styledtextclob) {
