 ...
 */
@Entity
@Table(name = "aris_group_attr")
public class ArisGroupAttrBean {
    ...
    /**
     * @param plaintnffragment
     *            the plaintnffragment to set
     */
    ...
    /**
     * @param styledtextfragment
     *            the styledtextfragment to set
     */
    ...
    /**
     * @param styledtextclob
     *            the styledtextclob to set
     */
